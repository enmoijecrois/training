...
--
-- Structure de la table `d8_node__field_description`
--

DROP TABLE IF EXISTS `d8_node__field_description`;
CREATE TABLE IF NOT EXISTS `d8_node__field_description` (
...
--
-- Déchargement des données de la table `d8_node__field_description`
--

INSERT INTO `d8_node__field_description` (`bundle`, `deleted`, `entity_id`, `revision_id`, `langcode`, `delta`, `field_description_value`, `field_description_format`) VALUES
