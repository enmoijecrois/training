...
--
-- Structure de la table `d8_block_content__body`
--

DROP TABLE IF EXISTS `d8_block_content__body`;
CREATE TABLE IF NOT EXISTS `d8_block_content__body` (
...
--
-- Déchargement des données de la table `d8_block_content__body`
--

INSERT INTO `d8_block_content__body` (`bundle`, `deleted`, `entity_id`, `revision_id`, `langcode`, `delta`, `body_value`, `body_summary`, `body_format`) VALUES
