...
--
-- Structure de la table `d8_node__field_photos_restaurant`
--

DROP TABLE IF EXISTS `d8_node__field_photos_restaurant`;
CREATE TABLE IF NOT EXISTS `d8_node__field_photos_restaurant` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Data storage for node field field_photos_restaurant.';

--
-- Déchargement des données de la table `d8_node__field_photos_restaurant`
--

INSERT INTO `d8_node__field_photos_restaurant` (`bundle`, `deleted`, `entity_id`, `revision_id`, `langcode`, `delta`, `field_photos_restaurant_target_id`, `field_photos_restaurant_alt`, `field_photos_restaurant_title`, `field_photos_restaurant_width`, `field_photos_restaurant_height`) VALUES
