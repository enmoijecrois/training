...
--
-- Structure de la table `d8_cache_dynamic_page_cache`
--

DROP TABLE IF EXISTS `d8_cache_dynamic_page_cache`;
CREATE TABLE IF NOT EXISTS `d8_cache_dynamic_page_cache` (
