...
--
-- Structure de la table `d8_node_revision__field_photos`
--

DROP TABLE IF EXISTS `d8_node_revision__field_photos`;
CREATE TABLE IF NOT EXISTS `d8_node_revision__field_photos` (
...
--
-- Déchargement des données de la table `d8_node_revision__field_photos`
--

INSERT INTO `d8_node_revision__field_photos` (`bundle`, `deleted`, `entity_id`, `revision_id`, `langcode`, `delta`, `field_photos_target_id`, `field_photos_alt`, `field_photos_title`, `field_photos_width`, `field_photos_height`) VALUES
