...
--
-- Structure de la table `d8_node_revision__field_tags`
--

DROP TABLE IF EXISTS `d8_node_revision__field_tags`;
CREATE TABLE IF NOT EXISTS `d8_node_revision__field_tags` (
