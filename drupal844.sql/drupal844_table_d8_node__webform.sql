...
--
-- Structure de la table `d8_node__webform`
--

DROP TABLE IF EXISTS `d8_node__webform`;
CREATE TABLE IF NOT EXISTS `d8_node__webform` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Data storage for node field webform.';
