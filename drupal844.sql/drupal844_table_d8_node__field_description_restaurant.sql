...
--
-- Structure de la table `d8_node__field_description_restaurant`
--

DROP TABLE IF EXISTS `d8_node__field_description_restaurant`;
CREATE TABLE IF NOT EXISTS `d8_node__field_description_restaurant` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Data storage for node field field_description_restaurant.';

--
-- Déchargement des données de la table `d8_node__field_description_restaurant`
--

INSERT INTO `d8_node__field_description_restaurant` (`bundle`, `deleted`, `entity_id`, `revision_id`, `langcode`, `delta`, `field_description_restaurant_value`, `field_description_restaurant_format`) VALUES
