...
--
-- Structure de la table `d8_field_deleted_revision_cc2a6b0fdc`
--

DROP TABLE IF EXISTS `d8_field_deleted_revision_cc2a6b0fdc`;
CREATE TABLE IF NOT EXISTS `d8_field_deleted_revision_cc2a6b0fdc` (
